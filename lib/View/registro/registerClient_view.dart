...
class RegisterClientWidget extends StatefulWidget {
  final User user;
  const RegisterClientWidget({Key? key, required this.user})
      : super(key: key);
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => RegisterClientWidget(
                            user: User(
                              nombre: 'nombre de ejemplo',
                              tipoRol: 'tipo de rol de ejemplo',
                              contrasenia: 'contraseña de ejemplo',
